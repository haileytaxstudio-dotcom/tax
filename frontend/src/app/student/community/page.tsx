                        ...
                        {submission.fileUrl ? (
                          <>
                            {isImageFile(submission.fileUrl) ? (
                              ...
                              <p className="text-gray-500 text-sm">미리보기 불가</p>
                            )}
                            <div className="mt-3 pt-3 border-t border-gray-100">
                              <a
                                href={`/api/download?url=${encodeURIComponent(submission.fileUrl)}&filename=${encodeURIComponent(submission.worksheetTitle + '_답안')}`}
                                className="inline-flex items-center px-3 py-1.5 text-sm text-blue-600 hover:text-blue-700 border border-blue-300 rounded-lg hover:bg-blue-50 transition-colors"
                              >
                                다운로드
                              </a>
                            </div>
